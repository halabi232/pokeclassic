const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BILL] = TRAINER_PIC_BILL,
    [FACILITY_CLASS_OAK] = TRAINER_PIC_OAK,
    [FACILITY_CLASS_SCOTT] = TRAINER_PIC_SCOTT,
    [FACILITY_CLASS_LEADER_BROCK] = TRAINER_PIC_BROCK,      
    [FACILITY_CLASS_LEADER_MISTY] = TRAINER_PIC_MISTY,        
    [FACILITY_CLASS_LEADER_SURGE] = TRAINER_PIC_SURGE,        
    [FACILITY_CLASS_LEADER_ERIKA] = TRAINER_PIC_ERIKA,        
    [FACILITY_CLASS_LEADER_KOGA] = TRAINER_PIC_KOGA,         
    [FACILITY_CLASS_LEADER_SABRINA] = TRAINER_PIC_SABRINA,      
    [FACILITY_CLASS_LEADER_BLAINE] = TRAINER_PIC_BLAINE,       
    [FACILITY_CLASS_ELITE_FOUR_LORELEI] = TRAINER_PIC_LORELEI,  
    [FACILITY_CLASS_ELITE_FOUR_BRUNO] = TRAINER_PIC_BRUNO,    
    [FACILITY_CLASS_ELITE_FOUR_AGATHA] = TRAINER_PIC_AGATHA,   
    [FACILITY_CLASS_ELITE_FOUR_LANCE] = TRAINER_PIC_LANCE,    
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LOOKER] = TRAINER_CLASS_GENTLEMAN,
    [FACILITY_CLASS_BILL] = TRAINER_CLASS_POKEMANIAC,
    [FACILITY_CLASS_OAK] = TRAINER_CLASS_COLLECTOR,
    [FACILITY_CLASS_SCOTT] = TRAINER_CLASS_POKEFAN,
    [FACILITY_CLASS_LEADER_BROCK] = TRAINER_CLASS_LEADER,    
    [FACILITY_CLASS_LEADER_MISTY] = TRAINER_CLASS_LEADER,       
    [FACILITY_CLASS_LEADER_SURGE] = TRAINER_CLASS_LEADER,      
