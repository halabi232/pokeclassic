...
struct SaveBlock1
{
    ...
    /*0x988*/ u8 seen1[NUM_DEX_FLAG_BYTES];   //52 bytes previously = u8 seen1[DEX_FLAGS_NO];
    #endif
    ...
    #ifndef FREE_EXTRA_SEEN_FLAGS
    /*0x3B24*/  u8 seen2[NUM_DEX_FLAG_BYTES];  //52 bytes previously = u8 seen2[DEX_FLAGS_NO];
    #endif
