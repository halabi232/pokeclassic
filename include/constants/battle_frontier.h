...
#define EXCHANGE_CORNER_ABILITY_CLERK    	0
#define EXCHANGE_CORNER_VITAMIN_CLERK    	1
#define EXCHANGE_CORNER_HOLD_ITEM_CLERK  	2
#define EXCHANGE_CORNER_HOLD_ITEM_CLERK_2  	3
